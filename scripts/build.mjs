...
async function loadEsbuild() {
  try {
    ...
    process.stderr.write("Build failed: missing required dev dependency 'esbuild'.\n");
    process.stderr.write("Run `npm ci` in the project root and retry `npm run build`.\n");
    process.stderr.write("This commonly happens when dependencies were installed with production-only mode.\n");
